...
import alumnos.model.Sintaxis;
import alumnos.model.Sintaxis.TipoSintaxis;
import java.io.File;
import java.net.URL;
...
public class FXMLsintaxisController implements Initializable {
    ...
    private final File def = new File(new File(System.getProperty("user.home")), "/CorregirPECs");
